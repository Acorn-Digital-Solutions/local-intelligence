...
3. https://api.open-meteo.com/v1/forecast?latitude=40.71&longitude=-74.01&current=temperature_2m
   — in what unit is the temperature reported?

Verify with `python3 check.py` — it must print `answers OK`.
No programming required; do not write scripts, just read and write words.
